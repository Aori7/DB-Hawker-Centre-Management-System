...
('CUST-003', 'S9876553G','Mavis Hee', '87635193', 'mavishee@gmail.com'),
('CUST-004', 'S9561222L', 'Ivan Heng','98753824', 'ivannh@gmail.com'),
('CUST-005', 'S8683772M','Heng Swee Keat','6813964','hskeat@gmail.com'),
('CUST-006', 'T0679234I','Christian Ho','98542783','chrisho@gmail.com'),
...
('AGR-001','2024-01-01','2025-01-02','Agreement outlining the rental terms for a food stall within a hawker centre.',600.00,'OWN-001','FS-01'),
('AGR-002','2024-02-03','2025-02-02','Agreement outlining the rental terms for a food stall within a hawker centre.',1200.00,'OWN-002','FS-02'),
('AGR-003','2024-01-25','2025-01-24','Agreement outlining the rental terms for a food stall within a hawker centre.',900.00,'OWN-003','FS-03'),
('AGR-004','2024-01-21','2025-01-20','Agreement outlining the rental terms for a food stall within a hawker centre.',940.00,'OWN-004','FS-04'),
('AGR-005','2024-02-10','2025-02-09','Agreement outlining the rental terms for a food stall within a hawker centre.',2010.00,'OWN-005','FS-05'),
('AGR-006','2024-02-15','2025-02-14','Defines the conditions, rental period, and obligations for leasing a hawker stall',900.00,'OWN-006','FS-06'),
('AGR-007','2024-03-02','2025-03-01','Defines the conditions, rental period, and obligations for leasing a hawker stall',1200.00,'OWN-007','FS-07'),
('AGR-008','2024-02-25','2025-02-24','Defines the conditions, rental period, and obligations for leasing a hawker stall',900.00,'OWN-008','FS-08'),
('AGR-009','2024-03-17','2025-03-16','Rental agreement governing the use of a food stall at a designated hawker centre',900.00,'OWN-009','FS-09'),
('AGR-010','2024-03-19','2025-03-18','Rental agreement governing the use of a food stall at a designated hawker centre',1200.00,'OWN-010','FS-10'),
('AGR-011','2024-03-29','2025-03-28','Rental agreement governing the use of a food stall at a designated hawker centre',900.00,'OWN-011','FS-11'),
('AGR-012','2024-04-03','2025-04-02','Rental agreement governing the use of a food stall at a designated hawker centre',1200.00,'OWN-012','FS-12'),
('AGR-013','2024-04-14','2025-04-13','Specifies rental fees, lease duration, and rules for operating a food stall',1200.00,'OWN-013','FS-13'),
('AGR-014','2024-04-17','2025-04-16','Specifies rental fees, lease duration, and rules for operating a food stall',940.00,'OWN-014','FS-14'),
('AGR-015','2024-05-25','2025-05-24','Agreement between the operator and vendor for stall rental within the hawker centre',940.00,'OWN-015','FS-15'),
('AGR-016','2024-06-04','2025-06-03','Sets out the terms for leasing and using a hawker food stall',940.00,'OWN-016','FS-16'),
('AGR-017','2024-06-24','2025-06-23','Sets out the terms for leasing and using a hawker food stall',940.00,'OWN-017','FS-17'),
('AGR-018','2024-06-30','2025-06-29','Sets out the terms for leasing and using a hawker food stall',940.00,'OWN-018','FS-18'),
('AGR-019','2024-07-13','2025-07-12','Rental contract detailing stall usage, payments, and compliance requirements',600.00,'OWN-019','FS-19'),
/* CURRENT (active in 2026)*/
('AGR-020','2025-01-08','2026-01-07','Defines the rights and responsibilities of vendors renting a food stall.',900.00,'OWN-001','FS-01'),
('AGR-021','2025-01-15','2026-01-14','Defines the rights and responsibilities of vendors renting a food stall.',900.00,'OWN-002','FS-02'),
('AGR-022','2025-01-22','2026-01-21','Defines the rights and responsibilities of vendors renting a food stall.',1000.00,'OWN-003','FS-03'),
('AGR-023','2025-01-21','2026-01-20','Defines the rights and responsibilities of vendors renting a food stall.',2000.00,'OWN-004','FS-04'),
('AGR-024','2025-01-28','2026-01-27','Defines the rights and responsibilities of vendors renting a food stall.',990.00,'OWN-005','FS-05'),
('AGR-025','2025-02-15','2026-02-14','Agreement covering stall rental conditions and operational requirements',900.00,'OWN-006','FS-06'),
('AGR-026','2025-02-25','2026-02-24','Agreement covering stall rental conditions and operational requirements',2800.00,'OWN-007','FS-07'),
('AGR-027','2025-03-03','2026-03-02','Agreement covering stall rental conditions and operational requirements',2100.00,'OWN-008','FS-08'),
('AGR-028','2025-03-17','2026-03-16','Outlines rental obligations for vendors operating food stalls in the hawker centre',800.00,'OWN-009','FS-09'),
('AGR-029','2025-03-21','2026-03-20','Outlines rental obligations for vendors operating food stalls in the hawker centre',2600.00,'OWN-010','FS-10'),
('AGR-030','2025-03-29','2026-03-28','Outlines rental obligations for vendors operating food stalls in the hawker centre',1600.00,'OWN-011','FS-11'),
('AGR-031','2025-04-02','2026-04-01','Outlines rental obligations for vendors operating food stalls in the hawker centre',1200.00,'OWN-012','FS-12'),
('AGR-032','2025-04-14','2026-04-13','Agreement between the operator and vendor for stall rental within the hawker centre',920.00,'OWN-013','FS-13'),
('AGR-033','2025-04-17','2026-04-16','Agreement between the operator and vendor for stall rental within the hawker centre',340.00,'OWN-014','FS-14'),
('AGR-034','2025-05-25','2026-05-24','Agreement between the operator and vendor for stall rental within the hawker centre',980.00,'OWN-015','FS-15'),
('AGR-035','2025-06-04','2026-06-03','Sets out the terms for leasing and using a hawker food stall',480.00,'OWN-016','FS-16'),
('AGR-036','2025-06-24','2026-06-23','Sets out the terms for leasing and using a hawker food stall',700.00,'OWN-017','FS-17'),
('AGR-037','2025-06-30','2026-06-29','Sets out the terms for leasing and using a hawker food stall',1600.00,'OWN-018','FS-18'),
('AGR-038','2025-07-13','2026-07-12','Defines the rights and responsibilities of vendors renting a food stall',960.00,'OWN-019','FS-19');
...
('ORDER-001',1,'FS-01','ITEM-01',2,11.50),
('ORDER-001',2,'FS-01','ITEM-02',1,12.50),
('ORDER-002',1,'FS-02','ITEM-04',1,6.50),
('ORDER-002',2,'FS-02','ITEM-05',1,6.00),
('ORDER-003',1,'FS-03','ITEM-07',1,21.00),
('ORDER-004',1,'FS-04','ITEM-08',1,7.00),
('ORDER-004',2,'FS-04','ITEM-09',2,1.50),
('ORDER-005',1,'FS-05','ITEM-11',2,4.00),
('ORDER-006',1,'FS-06','ITEM-13',1,6.50),
('ORDER-006',2,'FS-06','ITEM-14',2,1.00),
('ORDER-007',1,'FS-07','ITEM-15',2,5.00),
('ORDER-008',1,'FS-08','ITEM-17',1,6.00),
('ORDER-008',2,'FS-08','ITEM-20',2,1.50),
('ORDER-009',1,'FS-09','ITEM-21',1,10.00),
('ORDER-010',1,'FS-10','ITEM-23',3,6.00),
('ORDER-011',1,'FS-11','ITEM-25',1,4.50),
('ORDER-012',1,'FS-12','ITEM-26',1,8.50),
('ORDER-012',2,'FS-12','ITEM-27',1,9.00),
('ORDER-013',1,'FS-14','ITEM-30',2,1.60),
('ORDER-014',1,'FS-15','ITEM-32',1,15.70),
('ORDER-015',1,'FS-16','ITEM-33',2,3.50),
('ORDER-015',2,'FS-16','ITEM-34',1,4.00),
('ORDER-016',1,'FS-17','ITEM-35',1,9.50),
('ORDER-017',1,'FS-18','ITEM-36',1,9.50),
('ORDER-018',1,'FS-19','ITEM-37',2,2.80),
('ORDER-019',1,'FS-01','ITEM-03',1,10.50),
('ORDER-020',1,'FS-02','ITEM-04',2,6.50),
('ORDER-021',1,'FS-03','ITEM-06',1,7.00),
('ORDER-022',1,'FS-04','ITEM-08',1,7.00),
('ORDER-023',1,'FS-05','ITEM-11',1,4.00),
('ORDER-024',1,'FS-06','ITEM-13',2,6.50),
('ORDER-025',1,'FS-07','ITEM-15',1,5.00),
('ORDER-026',1,'FS-08','ITEM-18',1,4.00),
('ORDER-027',1,'FS-09','ITEM-22',1,9.50),
('ORDER-028',1,'FS-10','ITEM-24',2,7.00),
('ORDER-029',1,'FS-11','ITEM-25',1,4.50),
('ORDER-030',1,'FS-12','ITEM-27',1,9.00),
('ORDER-031',1,'FS-13','ITEM-28',2,1.00),
('ORDER-032',1,'FS-14','ITEM-31',1,2.20),
('ORDER-033',1,'FS-15','ITEM-32',1,15.70),
('ORDER-034',1,'FS-16','ITEM-33',1,3.50),
('ORDER-035',1,'FS-17','ITEM-35',2,9.50),
('ORDER-036',1,'FS-18','ITEM-36',1,9.50),
('ORDER-037',1,'FS-19','ITEM-38',2,2.10),
('ORDER-038',1,'FS-01','ITEM-02',1,12.50),
